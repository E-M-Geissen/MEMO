...
syms mu_M2_0_1 esigma_M2_0_1 mu_M2_0_2 esigma_M2_0_2 w_M2_0_3 mu_M2_0_3 esigma_M2_0_3 w_M2_0_2 ;

parameters.sym  = [ mu_M2_0_1 ; esigma_M2_0_1 ;mu_M2_0_2 ; esigma_M2_0_2 ; w_M2_0_3;mu_M2_0_3 ; esigma_M2_0_3 ; w_M2_0_2];

%parameters.name = {'mu_1_{M2,0}' ; 'esigma_1_{M2,0}' ;'mu_1_{M2,0}' ; 'esigma_1_{M2,0}' ;'w_{M2,0}'};

parameters.name = {'\mu_1' ; 'log(\sigma_1)' ;'\mu_2' ; 'log(\sigma_2)' ;'w2';'\mu_3' ; 'log(\sigma_3)';'w3'};

parameters.number = length(parameters.sym);
parameters.guess = zeros(parameters.number,1);
parameters.min  = [  log(5); log(1e-2);log(5); log(1e-2);0;log(5); log(1e-2);0];      
...
M.experiment(i).w     = {1-w_M2_0_2-w_M2_0_3,w_M2_0_2,w_M2_0_3};
M.experiment(i).mu    = {mu_M2_0_1,mu_M2_0_2,mu_M2_0_3};
M.experiment(i).sigma = {exp(esigma_M2_0_1),exp(esigma_M2_0_2),exp(esigma_M2_0_3)};
