...
%% OPTIONS
plot_opt = 'false'; % 'true';%plots are not  shown

%% Model
model_Mad2_all_vv_John_SU; % only Mad2 delta, discrete interval: 5min
...
% Print full model and best reduced model for BIC comparison
printModel(M,parameters)
