...
syms mu_batf_1 log_sigma_batf_1 mu_batf_2 log_sigma_batf_2  w_batf...
     mu_gata3_1 log_sigma_gata3_1 mu_gata3_2 log_sigma_gata3_2 w_gata3...
     mu_il4ra_1 log_sigma_il4ra_1 mu_il4ra_2 log_sigma_il4ra_2 w_il4ra...
     mu_il2ra_1 log_sigma_il2ra_1 mu_il2ra_2 log_sigma_il2ra_2 w_il2ra;

parameters.sym  = [ mu_batf_1; log_sigma_batf_1; mu_batf_2; log_sigma_batf_2; w_batf ;...
     mu_gata3_1; log_sigma_gata3_1; mu_gata3_2; log_sigma_gata3_2; w_gata3; ...
     mu_il4ra_1; log_sigma_il4ra_1; mu_il4ra_2; log_sigma_il4ra_2; w_il4ra; ...
     mu_il2ra_1; log_sigma_il2ra_1; mu_il2ra_2; log_sigma_il2ra_2; w_il2ra];

parameters.name = {'\mu_{batf_1}'; 'log(\sigma_{batf_1)}'; '\mu_{batf_2}'; 'log(\sigma_{batf_2})'; 'w_{batf}' ;  ...
     '\mu_{gata3_1}'; 'log(\sigma_{gata3_1)}'; '\mu_{gata3_2}'; 'log(\sigma_{gata3_2)}'; 'w_{gata3}';...
     '\mu_{il4ra_1}'; 'log(\sigma_{il4ra_1)}'; '\mu_{il4ra_2}'; 'log(\sigma_{il4ra_2)}'; 'w_{il4ra}'; ...
     '\mu_{il2ra_1}'; 'log(\sigma_{il2ra_1)}'; '\mu_{il2ra_2}'; 'log(\sigma_{il2ra_2)}'; 'w_{il2ra}' };
...
parameters.min  = [  2; -2;2; -2;0; 
    2; -2;2; -2;0;
    2; -2;2; -2;0;
    2; -2;2; -2;0 ];      
% As lower bound for the and mean we used the
% inter-observation time.
parameters.max  = [ 15; 5;15; 5;1;
    15; 5;15; 5;1;
    15; 5;15; 5;1;
                    10; 5;15; 5;1];
...
M.experiment(i).w     = {1-w_batf,w_batf};
...
M.experiment(i).name  = tit;
M.experiment(i).size  = 2;
M.experiment(i).w     = {1-w_gata3,w_gata3};
...
M.experiment(i).name  = tit;
M.experiment(i).size  = 2;
M.experiment(i).w     = {1-w_il4ra,w_il4ra};
...
M.experiment(i).name  = tit;
M.experiment(i).size  = 2;
M.experiment(i).w     = {1-w_il2ra,w_il2ra};
