% johncdf computes the cumulative probability of the values x under the 
%   Johnson SU distribution with parameters gamma, sigma, lambda, and xi
%
% USAGE:
% ======
% f = johncdf(x,gamma,sigma,lambda,xi)
%
% INPUTS:
% =======
...
z = (x-xi)./lambda;
f = cdf('norm',gamma + sigma*asinh(z),0,1);
