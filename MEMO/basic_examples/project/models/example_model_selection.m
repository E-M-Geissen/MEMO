...
syms mu_1_exp1     log_sigma_1_exp1    mu_2_exp1     log_sigma_2_exp1    w_exp1      ...
     mu_1_exp2     log_sigma_1_exp2    mu_2_exp2     log_sigma_2_exp2    w_exp2      ...
     mu_1_exp3     log_sigma_1_exp3    mu_2_exp3     log_sigma_2_exp3    w_exp3;
 
parameters.sym  = [mu_1_exp1;     log_sigma_1_exp1;    mu_2_exp1;     log_sigma_2_exp1;    w_exp1;      ...
                   mu_1_exp2;     log_sigma_1_exp2;    mu_2_exp2;     log_sigma_2_exp2;    w_exp2;      ...
                   mu_1_exp3;     log_sigma_1_exp3;    mu_2_exp3;     log_sigma_2_exp3;    w_exp3];
               
parameters.name = {'\mu_1_{exp1}';     'log(\sigma_1_{exp1})';    'mu_2_{exp1}';     'log(\sigma_2_{exp1})';    'w_{exp1}';  ...
...
M.experiment(i).sigma  = {exp(log_sigma_1_exp1),exp(log_sigma_2_exp1)};
